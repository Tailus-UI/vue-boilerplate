        ...
        <div class="mt-12 grid w-full grid-cols-2 gap-4 pb-32 sm:grid-cols-4">
          ...
          <div class="flex flex-col space-y-4">
            <a
              ...
              href="https://twitter.com/meschacirung"
              >Twitter</a
            >
            <a
              class="text-gray-500 transition hover:text-gray-300"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/m%C3%A9schac-irung-b8b831194/"
              >LinkedIn</a
            >
          </div>
          <div class="flex flex-col space-y-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://medium.com/@irung.ux"
              >Articles</a
            >
            <a
              class="text-gray-500 transition hover:text-gray-300"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://tailwindcomponents.com/u/tailus-ui"
              >UI Components</a
            >
          </div>
          <div class="flex flex-col space-y-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.patreon.com/irung"
              >Patreon</a
            >
            <a
              class="text-gray-500 transition hover:text-gray-300"
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.buymeacoffee.com/irung"
              >Buy Me a Coffee</a
            >
          </div>
        </div>

        <div class="w-full text-sm pt-6 border-gray-100 border-t flex flex-wrap gap-4 justify-center sm:justify-between dark:border-gray-700">
            <span class="text-gray-500 dark:text-gray-600"> Ⓒ Tailus 2021 - Present | All right reserved</span>
            <span class="text-gray-500 dark:text-gray-600">Proudly made in DR Congo</span>
        </div>
      </div>
  </footer>
</template>